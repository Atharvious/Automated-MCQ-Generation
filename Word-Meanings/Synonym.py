import os
os.chdir("E:\\Academics\\Aptence\\KDE data\\")
...
import pandas as pd
file_path = ("E:\\Academics\\Aptence\\KDE data\\")

class Generator:
    def __init__(self, exp_path, file_name):
        self.get_text()
    ...
    def save_data(self):
        ...
        try:
            df.to_csv(self.exp_path+self.file_name+".csv")
        except PermissionError:
            self.file_name.append("_")
            df.to_csv(self.exp_path+self.file_name+"_1.csv")
